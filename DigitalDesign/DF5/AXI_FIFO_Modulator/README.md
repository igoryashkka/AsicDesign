...
This project builds on `DF4/AXI_Slave_example` (MicroBlaze block design). The interconnect between
MicroBlaze and the peripheral is a **stock Vivado IP block** (AXI Interconnect / AXI SmartConnect added
...
* Set **VHDL 2008** for all VHDL source files (except `top.vhd`, which should keep its original standard).
